        ...
        <div className="space-y-3 sm:space-y-4">
          {portfolioData.featured.map((project, index) => (
            <Link
              key={index}
              href={project.url}
              className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 rounded-lg border border-border bg-secondary/50 hover:bg-secondary/80 transition-all duration-200 group"
            >
